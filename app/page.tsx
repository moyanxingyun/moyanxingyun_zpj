...
type CampaignStatus = "正在招聘" | "实习可转正" | "持续开放" | "入口关注" | "待核验" | "当前无美术岗" | "已结束参考";
...
const demoJobs: Job[] = [
  ...
  },
  {
    ...
    opportunityType: "正式校招",
    scaleTier: "中型企业",
    tags: ["27届秋招", "地编", "UE5", "写实场景"],
    business: "内容型游戏与二次元游戏研发",
    scale: "中型游戏研发公司（高校就业平台披露150–500人）",
    project: "重返未来：1999及UE5在研项目",
    source: "深蓝互动官方校招入口、认证微博及第三方企业职位页",
    sourceUrl: "https://campus.bluepoch.com/campus_apply/blueinteractive/38434/",
    campaign: "待核验",
    verifiedAt: "2026-08-28",
    publishedAt: "2026-08-10",
    availabilityNote: "官方已确认2027届秋招、美术设计类、广州及网申入口｜具体“地编设计师（UE5在研）”JD目前仅在第三方企业职位页可见，官方动态职位页未能直接核验，因此暂标待核验，不作为“正在招聘”",
    responsibilities: ["根据概念设计和灰盒进行场景编辑，提升视觉引导与可玩性", "通过灯光、雾效和色彩塑造场景氛围，并参与生态与3A级场景表现搭建", "以上具体职责来自第三方企业职位页，仍须以官方职位详情复核"],
    requirements: ["第三方职位页显示面向2027届本科及以上毕业生，美术相关专业", "熟悉UE场景编辑，具备写实场景、空间节奏与视觉引导能力", "了解UE材质、蓝图等功能，热爱3A游戏并具备团队协作能力", "具体职位是否仍开放、项目归属及作品集要求须在官方投递系统再次确认"],
    reasons: ["地编方向与UE5场景搭建、空间叙事和环境氛围能力高度匹配", "官方已确认本轮秋招包含美术设计类且工作地点为广州", "若官方职位系统可检索到该岗位，可作为场景美术与关卡美术之间的高匹配选择"],
    missing: ["先在官方系统确认具体职位仍开放再投递", "建议作品集增加灰盒到终稿、视觉引导和灯光氛围的过程拆解", "准备UE材质、蓝图及场景性能优化的可验证说明"],
    accent: "#33458f",
  },
  {
    id: 55,
    company: "炎魂网络（Pandada Studio）",
    initials: "YH",
    role: "2027届｜场景模型",
    city: "杭州",
    deadline: "官网未公布统一截止日",
    ...
    opportunityType: "正式校招",
    scaleTier: "中型企业",
    tags: ["27届校招", "场景模型", "PBR/NPR", "Unity"],
    business: "精品原创游戏研发与全球发行运营",
    scale: "中型游戏研发公司（高校就业平台披露200–500人）",
    project: "忍者必须死3及多个原创在研项目",
    source: "炎魂网络官方校园招聘站及官方Moka职位页",
    sourceUrl: "https://app.mokahr.com/campus-recruitment/yanhun/24017#/job/993e6f7c-7642-43a6-9e9f-e6a0f922caa5",
    campaign: "正在招聘",
    verifiedAt: "2026-08-29",
    publishedAt: "2026-08-12",
    availabilityNote: "官方Moka职位接口当前状态为open｜职位于2026-08-12开放｜官网未公布统一截止日｜职位详情未单列地点，结合官方校园站与公司所在地标注杭州，投递前请再次确认",
    responsibilities: ["依据原画设定制作物件、建筑、载具等场景资源，并跟进游戏内表现", "完成模型、拓扑、UV、贴图与材质的完整制作流程，覆盖PBR或NPR项目需求", "参与场景美术风格探索、模板与质量标准建设，并兼顾资源美术效果和运行性能"],
    requirements: ["面向2027届及以后本科及以上毕业生，美术相关专业优先；优秀3D场景作品可放宽专业限制", "熟练使用3ds Max、Maya或Blender至少一种，掌握建模、拓扑、UV与贴图流程", "理解PBR或NPR制作思路，具备空间、结构、色彩与材质判断力", "具备良好美术基础、学习能力和团队协作意识"],
    portfolioRequirements: ["建议展示从模型、拓扑、UV到贴图和材质的完整场景资产流程", "建筑、载具、自然环境或风格化道具作品可作为重点案例", "Unity材质调试、灯光氛围或新工具与流程优化经验为加分项"],
    reasons: ["具体岗位直接对应场景模型与完整资产生产流程", "PBR/NPR双路线适合同时展示写实材质与风格化场景能力", "Unity、灯光氛围和流程优化加分项可承接你的引擎内场景作品"],
    missing: ["官方职位详情未单列工作地点，投递前需在申请表再次确认", "官网未公布统一截止日，岗位可能随招聘进度关闭", "建议为作品补充面数、贴图规格、材质拆解与引擎内效果对照"],
    accent: "#e39a27",
  },
  {
    id: 2,
  ...
  {
    id: 11, company: "库洛游戏", initials: "KU", role: "2027届秋招｜3D场景模型", city: "广州", deadline: "招满即止", daysLeft: 99, match: 97, status: "准备中", opportunityType: "正式校招", scaleTier: "大型企业",
    tags: ["27届秋招", "3D场景模型", "地编", "UE4/UE5"], business: "二次元动作游戏研发与全球发行", scale: "大型游戏研发公司", project: "鸣潮、战双帕弥什", source: "库洛游戏2027秋招官方投递系统及官方招聘公众号", sourceUrl: "https://kurogame.jobs.feishu.cn/campus/", campaign: "正在招聘", verifiedAt: "2026-08-25", publishedAt: "2026-08-18", availabilityNote: "库洛游戏2027届秋季校园招聘已开放｜广州、上海｜3D场景模型岗位位于广州｜同批次另有3D场景地编（发行）、2D场景、技术美术和环境灯光等岗位｜招满即止",
    responsibilities: ["根据项目风格与场景原画设计意图制作3D场景模型。", "独立完成模型、材质与贴图制作，并进行后期模型性能优化。"],
...
function getDetailLevel(job: Job): DetailLevel {
  if (job.campaign === "当前无美术岗" || job.campaign === "待核验") return "招聘批次";
...
function getDeadlineProfile(job: Job): DeadlineProfile {
  const base: DeadlineProfile = {
    ...
    urgency: job.campaign === "已结束参考" ? "closed" : job.campaign === "入口关注" || job.campaign === "待核验" || job.campaign === "当前无美术岗" ? "watch" : job.deadline.includes("招满") || job.deadline.includes("滚动") ? "rolling" : "open",
  };
